...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-paper text-ink">
      ...
      <footer className="mx-auto flex max-w-7xl flex-col gap-5 px-6 py-8 text-sm text-muted sm:flex-row sm:items-center sm:justify-between lg:px-10"><span className="font-bold text-ink">Doerforge <span className="font-normal text-muted">by Alex Studio</span></span><div className="flex flex-wrap gap-x-5 gap-y-2"><Link href="/privacy" className="hover:text-ink">Privacy</Link><Link href="/terms" className="hover:text-ink">Terms</Link><Link href="/refunds" className="hover:text-ink">Refunds</Link><Link href="/contact" className="hover:text-ink">Contact</Link><span>© 2026</span></div></footer>
    </main>
  );
}
